...
class BirthFeedingAndVaccineFormValidator(ChildFormValidatorMixin,
    ...
    def validate_feeding(self):
        ...
        breast_feeding_condition = feeding_after_delivery in [BREASTFEED_ONLY, BOTH_BREAST_FEEDING_AND_FORMULA]
        formula_feeding_condition = feeding_after_delivery in [FORMULA_ONLY, BOTH_BREAST_FEEDING_AND_FORMULA]
