...
class TestChildAssentForm(TestCase):
    ...
    def test_assent_dob_mismatch_consent_child_dob(self):
        self.subject_consent.child_dob = (get_utcnow() - relativedelta(years=9)).date()
        self.subject_consent.save_base(raw=True)
    ...
    def test_child_age_less_than_7years(self):
        self.subject_consent.child_dob = (get_utcnow() - relativedelta(years=6)).date()
        self.subject_consent.save_base(raw=True)
